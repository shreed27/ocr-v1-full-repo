...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('canvas_canvas', (
            ...
            ('stdanswer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['question.StandardAnswer'], null=True, blank=True)),
            ('stuanswer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['student.StudentAnswer'], null=True, blank=True)),
    ...
    models = {
        ...
        'canvas.canvas': {
            ...
            'stdanswer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['question.StandardAnswer']", 'null': 'True', 'blank': 'True'}),
            'stuanswer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['student.StudentAnswer']", 'null': 'True', 'blank': 'True'})
        },
        'classroom.classroom': {
