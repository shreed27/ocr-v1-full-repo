...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MCQ_StudentAnswer.sta_paper'
        db.add_column('mcq_mcq_studentanswer', 'sta_paper',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mcq.MCQ_Paper']),
                      keep_default=False)

        # Adding field 'MCQ_StudentRetakeAnswer.srta_paper'
        db.add_column('mcq_mcq_studentretakeanswer', 'srta_paper',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mcq.MCQ_Paper']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MCQ_StudentAnswer.sta_paper'
        db.delete_column('mcq_mcq_studentanswer', 'sta_paper_id')

        # Deleting field 'MCQ_StudentRetakeAnswer.srta_paper'
        db.delete_column('mcq_mcq_studentretakeanswer', 'srta_paper_id')
    ...
    models = {
        ...
        'mcq.mcq_studentanswer': {
            ...
            'sta_paper': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mcq.MCQ_Paper']"}),
        ...
        'mcq.mcq_studentretakeanswer': {
            ...
            'srta_paper': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mcq.MCQ_Paper']"}),
