...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field qct_teacher on 'MCQ_QuestionCategory'
        m2m_table_name = db.shorten_name('mcq_mcq_questioncategory_qct_teacher')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mcq_questioncategory', models.ForeignKey(orm['mcq.mcq_questioncategory'], null=False)),
            ('tprofile', models.ForeignKey(orm['portal.tprofile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['mcq_questioncategory_id', 'tprofile_id'])


    def backwards(self, orm):
        # Removing M2M table for field qct_teacher on 'MCQ_QuestionCategory'
        db.delete_table(db.shorten_name('mcq_mcq_questioncategory_qct_teacher'))
