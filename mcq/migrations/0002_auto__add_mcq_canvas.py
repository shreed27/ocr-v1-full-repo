...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MCQ_Canvas'
        db.create_table('mcq_mcq_canvas', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mcq.MCQ_Question'])),
            ('stdoption', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mcq.MCQ_Optionlist'], null=True, blank=True)),
            ('stuanswer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mcq.MCQ_StudentAnswer'], null=True, blank=True)),
        ...
        db.send_create_signal('mcq', ['MCQ_Canvas'])


    def backwards(self, orm):
        # Deleting model 'MCQ_Canvas'
        db.delete_table('mcq_mcq_canvas')
