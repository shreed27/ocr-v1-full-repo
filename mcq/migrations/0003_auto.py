...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field itp_accessible on 'MCQ_Itempool'
        m2m_table_name = db.shorten_name('mcq_mcq_itempool_itp_accessible')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mcq_itempool', models.ForeignKey(orm['mcq.mcq_itempool'], null=False)),
            ('tprofile', models.ForeignKey(orm['portal.tprofile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['mcq_itempool_id', 'tprofile_id'])


    def backwards(self, orm):
        # Removing M2M table for field itp_accessible on 'MCQ_Itempool'
        db.delete_table(db.shorten_name('mcq_mcq_itempool_itp_accessible'))
