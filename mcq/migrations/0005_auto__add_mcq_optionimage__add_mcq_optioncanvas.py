...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MCQ_OptionImage'
        db.create_table('mcq_mcq_optionimage', (
            ...
            ('option', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mcq.MCQ_Optionlist'])),
            ('qti_digest', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('mcq', ['MCQ_OptionImage'])

        # Adding model 'MCQ_OptionCanvas'
        db.create_table('mcq_mcq_optioncanvas', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('option', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mcq.MCQ_Optionlist'], null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('axismap', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('drawopts', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('pointlist', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('mark', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('mcq', ['MCQ_OptionCanvas'])


    def backwards(self, orm):
        # Deleting model 'MCQ_OptionImage'
        db.delete_table('mcq_mcq_optionimage')

        # Deleting model 'MCQ_OptionCanvas'
        db.delete_table('mcq_mcq_optioncanvas')
    ...
    models = {
        ...
        'mcq.mcq_optioncanvas': {
            'Meta': {'object_name': 'MCQ_OptionCanvas'},
            'axismap': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'drawopts': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mark': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'markscheme': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'option': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mcq.MCQ_Optionlist']", 'null': 'True', 'blank': 'True'}),
            'pointlist': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'rulelist': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        'mcq.mcq_optionimage': {
            'Meta': {'object_name': 'MCQ_OptionImage'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'option': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mcq.MCQ_Optionlist']"}),
