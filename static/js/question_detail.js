            ...
            function(payload){
                if(payload.state === "success"){
                    ...
                    for (var t in thumbnails){
						...
						thumbhtml += '<a href="/static/'+thumbnails[t][2]+'" title="View Larger Image" id = "file_id" >';
						thumbhtml += '<img src="/static/'+thumbnails[t][0]+'"  alt="'+thumbnails[t][1]+'" width="96" height="72" id = "image_id"></img></a>';						
                        //thumbhtml += 'View Larger</a>';
                        if(!view){
