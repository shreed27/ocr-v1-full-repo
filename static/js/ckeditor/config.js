...
CKEDITOR.plugins.addExternal('mathedit', 'plugins/mathedit/', 'plugin.js');
CKEDITOR.plugins.addExternal('scienceedit', 'plugins/scienceedit/', 'plugin.js');
...
CKEDITOR.editorConfig = function( config )
{
	 ...
	 config.height = 445;
	 config.width = 600;
     config.extraPlugins = 'keystrokes,fmath_formula,mathedit,scienceedit';
	 ...
	 config.toolbar_Full =
		 [
			...
			{ name: 'insert', items : [ 'Table','HorizontalRule','SpecialChar','-', "mathedit","-","scienceedit"] },
