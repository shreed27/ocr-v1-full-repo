...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('student_studentanswer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portal.SProfile'])),
            ('sentencelist', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('mark', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('pointmarklist', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('omitted', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('html_answer', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('txt_answer', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['question.Question'])),
            ('timeleft', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('taked', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('grammar_issues', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('closeness', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('feedback', self.gf('django.db.models.fields.TextField')(max_length=255)),
            ('feedback_code', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('student', ['StudentAnswer'])

        # Adding M2M table for field stuansimages on 'StudentAnswer'
        m2m_table_name = db.shorten_name('student_studentanswer_stuansimages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('studentanswer', models.ForeignKey(orm['student.studentanswer'], null=False)),
            ('questionimage', models.ForeignKey(orm['question.questionimage'], null=False))
        ))
        db.create_unique(m2m_table_name, ['studentanswer_id', 'questionimage_id'])


    def backwards(self, orm):
        # Deleting model 'StudentAnswer'
        db.delete_table('student_studentanswer')

        # Removing M2M table for field stuansimages on 'StudentAnswer'
        db.delete_table(db.shorten_name('student_studentanswer_stuansimages'))
