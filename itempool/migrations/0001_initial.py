...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Itempool'
        db.create_table('itempool_itempool', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('poolname', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
        ...
        db.send_create_signal('itempool', ['Itempool'])


    def backwards(self, orm):
        # Deleting model 'Itempool'
        db.delete_table('itempool_itempool')
