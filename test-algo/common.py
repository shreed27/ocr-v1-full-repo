...
if __debug__:
    ...
    use_logger = getenv_boolean("USE_LOGGER", use_logger)
    if use_logger:
        # Get the logger for current module
        # Note: the logging settings should be configured elsewhere (e.g., settings.py)
