...
class Standard:
    ...
    # 
    # EX: PointAnalysis("3 . The PPC helps elucidate the meaning of scarcity , choice and opportunity cost. \n")
    # => [{'Point_No': 'P3', 'Point_Text': ' The PPC helps elucidate the meaning of scarcity , choice and opportunity cost.  '}]
    # EX: PointAnalysis("1.1 . One dot one.\n3.3 . Three dot three.\n")
    ...
    #
    # EX: SentenceAnalysis([{'Point_No': 'P3', 'Point_Text': ' The PPC helps elucidate the meaning of (((scarcity))) , (((choice))) and (((opportunity cost))).  '}])
    ...
    # EX: SentenceAnalysis([{'Point_No': 'P1.1', 'Point_Text': ' One dot one. '}, {'Point_No': 'P3.3', 'Point_Text': ' Three dot three. '}])
    ...
    #
    # EX: ParseKeyword("(((recession))) of 2008") => "recession of 2008"
    #
    ...
    #
    # EX: CalVector([{'KeyS': ' One dot one.', 'Point_No': 'P1.1', 'TotalS_No': [1], 'KeyBVec': [], 'No': 1}, {'KeyS': ' Three dot three.', 'Point_No': 'P3.3', 'TotalS_No': [2], 'KeyBVec': [], 'No': 2}]) => <FreqDist: 'one':2, 'dot':2, 'three':2>
    #
