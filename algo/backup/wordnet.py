...
# get_hypernym_terms(wordform, [max_dist=1]): Returns anector terms for WORDFORM using at most MAX_DIST links.
...
if __name__ == '__main__':
    if not __debug__:
        ...
        debug_print("All hypernym terms of lawyer: " + str(get_hypernym_terms("n:lawyer", max_dist=sys.maxsize)))
